public class MonthlyAttendanceAnnouncer {
    ...
    static class PremiumMember extends GymMember {
        ...
        String displayInfo() {
            return "Premium | Trainer: " + trainer + " | Sessions: 0";
        }
    }

    static String batchPrint(GymMember[] x) {
        StringBuilder b = new StringBuilder();

        for (GymMember m : x) {
            b.append(m.displayInfo());

            if (m instanceof PremiumMember) {
                b.append(" [Trainer via downcast: ")
                        .append(((PremiumMember) m).trainer)
                        .append("]");
            }
