...
public class RockPaperScissorsGame {
    ...
    public static void main(String[] args) {
        ...
        Random random = new Random(); int wins = 0, losses = 0, draws = 0;
        for (int i = 0; i < playerMoves.length; i++) {
            ...
            System.out.println("Round " + (i + 1) + " | " + playerMoves[i] + " | " + computer + " | " + result);
        }
        System.out.printf("Wins: %d | Losses: %d | Draws: %d | Win %% = %.1f%%%n", wins, losses, draws, wins * 100.0 / playerMoves.length);
    }
}
